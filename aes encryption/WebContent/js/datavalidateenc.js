...
function valid2() {
	...
	title = document.getElementById('val3').value;
...
function AESEncryption1(plaintext, password, nBits) {
	...
	document.getElementById('encrypt1').innerHTML = ctext1;
