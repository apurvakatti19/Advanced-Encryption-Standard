...
function load8() {
	...
	if (window.File && window.FileList && window.FileReader) {
		...
		var btnClick = document.getElementById("btn7");
		btnClick.addEventListener("click",function(event) {

							var files = document.getElementById("files3").files; // FileList
																					// object
							var output1 = document.getElementById("result1");
							document.getElementById("generics").innerHTML = "Decrypting...Please wait";
...
function valid10(title1) {
	pass = document.getElementById('val10').value;
	pass = pass.replace(/\r?\n/g, '<br />');
	pass = pass.replace(/\t/g,
			'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	

	bit = document.getElementById('val12').value;
	...
	AESDecryptCtr10(title1, pass, bit);
}
...
function upload14(image) {
	
	var b64Data = image.replace(/^data:application\/\w+;base64,|^data:application\/vnd.openxmlformats-officedocument.wordprocessingml.document\w*;base64,|^data:application\/vnd.ms-powerpoint\w*;base64,|^data:application\/vnd.openxmlformats-officedocument.presentationml.presentation\w*;base64,|^data:application\/vnd.ms-excel\w*;base64,|^data:application\/vnd.openxmlformats-officedocument.spreadsheetml.sheet\w*;base64,|^data:text\/plain\w*;base64,|^data:text\/html\w*;base64,|^data:text\/css\w*;base64,/,'');
	
	var blob = b64toBlob14(b64Data,'application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/plain,text/html,text/css');

	saveAs(blob, "decrypted data." + fileExtension);

}
function b64toBlob14(b64Data1, contentType, sliceSize) {
	contentType = contentType || '';
	sliceSize = sliceSize || 512;
	
	var byteCharacters = b64Data1;
	var byteArrays = [];
	...
	document.getElementById("generics").innerHTML = " ";

	return blob;
}
function upload13(image) {
	
	var b64Data = image.replace(/^data:application\/\w+;base64,|^data:application\/vnd.openxmlformats-officedocument.wordprocessingml.document\w*;base64,|^data:application\/vnd.ms-powerpoint\w*;base64,|^data:application\/vnd.openxmlformats-officedocument.presentationml.presentation\w*;base64,|^data:application\/vnd.ms-excel\w*;base64,|^data:application\/vnd.openxmlformats-officedocument.spreadsheetml.sheet\w*;base64,|^data:text\/plain\w*;base64,|^data:text\/html\w*;base64,|^data:text\/css\w*;base64,/,'');
	
	var blob = b64toBlob13(b64Data,'application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/plain,text/html,text/css');

	saveAs(blob, "decrypted data." + fileExtension);

}
function b64toBlob13(b64Data1, contentType, sliceSize) {
	contentType = contentType || '';
	sliceSize = sliceSize || 512;
...
function AESDecryptCtr10(text, password, nBits) {
	
	var b64Data = text.replace(/^data:application\/\w+;base64,|^data:application\/vnd.openxmlformats-officedocument.wordprocessingml.document\w*;base64,|^data:application\/vnd.ms-powerpoint\w*;base64,|^data:application\/vnd.openxmlformats-officedocument.presentationml.presentation\w*;base64,|^data:application\/vnd.ms-excel\w*;base64,|^data:application\/vnd.openxmlformats-officedocument.spreadsheetml.sheet\w*;base64,|^data:text\/plain\w*;base64,|^data:text\/html\w*;base64,|^data:text\/css\w*;base64,/,'');
	
	var ciphertext = decodeURIComponent(escape(window.atob(b64Data)));

	console.log('cipher text(file dec)');
	...
	ciphertext = ciphertext.split('-'); // split ciphertext into array of
	...
	if (ptext.match(/^data:application\/\w*|^data:text\/plain\w*;base64,|^data:text\/html\w*;base64,|^data:text\/css\w*;base64,/)) {
		upload13(ptext);
	} else {
		upload14(ptext);
	}
