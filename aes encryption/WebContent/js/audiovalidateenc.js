...
function load3() {
	...
	if (window.File && window.FileList && window.FileReader) {
		...
		btnClick.addEventListener("click",function(event) {
							...
							document.getElementById("generics1").innerHTML = "Encrypting...Please wait";
...
function upload5(image) {
	
	var b64Data = image.replace(/^data:audio\/\w+;base64,/, '');
	
	var blob = b64toBlob5(b64Data, 'audio,audio/x-ms-wma');
	
	saveAs(blob, "encrypted audio." + fileExtension);

}
function b64toBlob5(b64Data1, contentType, sliceSize) {
...
function AESEncryption5(plaintext, password, nBits) {
	...
	console.log('cipher text(audio enc)');
	console.log(ctext1);
