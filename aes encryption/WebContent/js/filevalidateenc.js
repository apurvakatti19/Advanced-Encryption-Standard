...
function upload12(image) {
	...
	var blob = b64toBlob12(b64Data,'application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/plain,text/html,text/css');

	saveAs(blob, "encrypted data." + fileExtension);

}
function b64toBlob12(b64Data1, contentType, sliceSize) {
...
function AESEncryption9(plaintext, password, nBits) {
	...
	console.log('cipher text(file enc)');
	console.log(ctext1);
