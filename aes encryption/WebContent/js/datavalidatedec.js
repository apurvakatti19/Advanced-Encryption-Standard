...
function validate1() {
	...
	title = document.getElementById('enc1').value;
	...
	console.log(password);
	bit = document.getElementById('bits1').value;
	...
	AESDecryptCtr1(title, password, bit);
...
function AESDecryptCtr1(ciphertext, password, nBits) {
	...
	console.log(ptext);
	document.getElementById('decrypt1').innerHTML = ptext;
